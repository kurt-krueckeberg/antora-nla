= Document 3: Guardianship Cammer Directive (11 Mar. 1799)
:page-role: wide
...
On March 11. 1799, the official reply of the Cammer to the Ämter (offices)
of Bückeburg and Arensburg was written. The header references (*"S.S"* in
upper left, meaning *referenced above*) the document denoted by *"Cam:53"*,
which is Document #2.

The Cammer states:

* They will allocate the land Krückeberg, no. 10 Berenbusch, provided he
  agrees to:
** plant three saplings at another forest site for each willow or poplar
   felled and sold by the forestry office
...
|===
|image::05-right-page.png[title="Document 2(Click to Enlarge)",link=self]
|image::06-left-page.png[title="Document 3(Click to Enlarge)",link=self]
|===
