...
After first reviewing Documenmt 2 on March 6, 1799, the Cammer noted on Document 2 their intention to approve
Jobst Heinrich's request and to allocated land for him to purchase.

This is the official reply from the Vormundliche Cammer to the Ämter (offices) of Bückeburg and Arensburg. The 
header references (*"S.S"*, meaing *referenced above*) the document denoted by *"Cam:53"*(in the header). This
is Document 2.

The Cammer states:

* They will allocate the land Krückeberg, no. 10 Berenbusch, provide he agrees to:
** he plant three saplings at another forest site for each willow or poplar felled and sold by the forestry
office
** he pays 24 Mariengroschen per square rod for the plot.
* If Krückeberg agrees to these conditions, the Amt is:
