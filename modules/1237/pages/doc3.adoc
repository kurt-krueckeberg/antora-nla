...
S. S.:: S.S. is a Latin abbreviation for supra scripta, which literally means “written above.” It doesn’t point to
something higher on the page — it points to an earlier entry in the same series or case file.
