...
*TODO:*
* Explain what this text is about, that it a reply to what they were sent.
* Explain how "S.S." tells us it was a reply, along with the fact that it was sent to
Bückeburg.
...
If we append the text from the left page of image 6 to the text of the right page of image 5, we have:
