= Image 5 Right Page and Image 6 Left Page (Under Development)
:page-role: wide

== Overview

*TODO:* Explain what this text is about, then include the explnation of the *document
reference heading*, which is already below:

The first line *"ad nr: Cam: 53. S. S.* serves a a *document reference heading*. It means:

[quote]
____
“This document pertains to Record Number 53 filed in the Chamber’s archive
(Cammer 53), and refers to matters previously recorded above or in associated
documents.”
____

The components of the *document reference heading* explained:
[arabic, start=1]
. *ad nr:*
** Is an Latin abbreviation meaning *"to number"*. It means: "Regarding No."
. *Cam:*
** Is the abbreviation for *"Cammer"*, meaing *"chamber"*, “This document
pertains to Record Number 53 filed in the Chamber’s archive (Cammer 53), and
refers to matters previously recorded above or in associated documents.”
. *53*
** This is the *document or file number* within the chamber's archive.
. *S.S.*
** Latin for _supra scripta_, meaning "written above" or *"as referenced above"*.
** It indicates that this record refers back to previously mentioned or filed
information (possibly another document in the same dossier or a previous
entry). 
