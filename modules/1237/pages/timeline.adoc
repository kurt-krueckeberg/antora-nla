...
Jobst Heinrich Krückeberg had to wait a year and a half for appproval of his request to enlarge his garden and farmyard.
During this time, two governmental bodies, the local *Amt* and the higher state-level *Cammer*, interact and six documents
are generated.
