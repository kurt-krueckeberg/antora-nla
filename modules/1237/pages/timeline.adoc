...
Amt::  
Amt = office. The *Amt* was the *local or
regional administrative office* responsible for executing the instructions of the Vormundlichte  Cammer
("gardianship" Chamber). It handled *field investigations, reports, local enforcement, and petitions*, and
