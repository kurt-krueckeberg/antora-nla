...
onto official paper, and Jobst Heinrich did not do this himself. The Amt also compiled a brief Forestry report
onto the same official paper and forwarded the document to the Cammer (central fiscal authority). The phrase
*"praes: 30. May 1798"* (short for praesentiert, presented) was written by the Amt, and it indicates the date the
...
assigning it an internal reference number “Cam: Nr: 662” and marking it as “Res Cam,” meaning it was formally
...
one-day discrepancy between 29 May (document dated by the Amt) and 30 May (date of presentation at the Cammer)
simply reflects this administrative transfer.
