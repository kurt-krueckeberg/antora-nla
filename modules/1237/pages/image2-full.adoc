...
This appears at the bottom of the backside of the page below the 2^nd^ half of 
the petition.
...
This is the large text in the image.
...
This text is written vertical along the left edge below the Land Assessment.
