...
.Explanatary Notes
****
* *Cam: Nr: 662* - *"Chamber [Office] Document No. 662"* or *"File No. 662 of the Fiscal Office"*.
* Res Can is likely shorthand for the latin *Rescriptum Cammerale*: 
** *Res* = abbreviation of Rescriptum (a written reply or decree).
** *Can* = abbreviation of Cammeral or Cammerale (chamber, as in Chancery or administrative office —
older spelling of Kammer).
****
