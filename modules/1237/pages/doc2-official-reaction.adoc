...
The *marginal note* in the image is a response to the remitted xref:doc2-report.adoc[Land
...
* Instructing the local officials to investigate other possibly unauthorized garden expansions in Berenbusch and
to report back.

It was written vertically in the left margin the Land Assignment report and encroaches on its text. To aid
readability, the text of the Land Assigment Report has been erased from the image below:

image::03-right-page-left-margin-text.png[link=self]

== Transliteration of Official Reaction to Petition and Land Assignment Report
...
darüber nähere Auskunft einzuziehen  
...
____
The plot is therefore to be allocated,
and since various residents in Berenbusch
are said to have enlarged their gardens on
their own authority, the officials are to
obtain further information about this and
report accordingly.
