...
This is the cardboard-like case file that holds six documents and a document index of the
> plots assigned to Colon (tenant farmer) Krückeberg, No. 10, in Berenbusch,  
