...
image::1237-cover.png[title="case file cover (click to enlarge),link=self]
...
[NOTE]
====
Hofraum can be translated *"farmyard"*, but this does not imply this was a
farm. Hofraum refers to he yard space of a rural household holding--the
...
[glossary]
Ausweisungen::
  Land allocations or assignments. Formal designation of land parcels,
often by government or ducal authority.
...
C. 67::
  A likely archival or administrative reference number. The letter "C" may
designate a filing category, shelf, or collection series, while "67"
indicates the item or folder number within that series. Such notations were
commonly written on dossier covers by clerks or archivists to organize case
files for internal tracking or retrieval.
