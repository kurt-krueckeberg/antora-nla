...
In this image, only the forestry report is present. The text to its right and below it, which
are visible in the xref:image2-intro.adoc[complete image], have been removed.
