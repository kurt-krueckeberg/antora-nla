...
The petition was drawn up by the local governmental administrative office (Amt) in Bückeburg and then sent to
the *Vormundschaftliche Cammer*, the guardianship chamber (also in Bückeberg), a state-level authority, who 
added all the text that appears in the header.
