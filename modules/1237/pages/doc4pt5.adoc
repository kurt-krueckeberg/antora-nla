...
xref:contents-list.adoc[logged] as an independent piece of correspondence, even though it accompanied
...
date March 30, 1799, but Document 4, which it supplemented, is dated over a year later, October 18, 1800.
