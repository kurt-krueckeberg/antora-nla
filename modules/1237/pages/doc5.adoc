= Document 5: Draft of Chamber's Official Resolutions to the Bückeburg Officials, and to the Fiscal Treasurer Stackmann
:page-role: wide
...
These two Offical Replies (Rescripts) represent the **final administrative stage** of the case:
