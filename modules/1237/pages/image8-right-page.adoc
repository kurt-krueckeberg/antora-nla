...
NOTE: The surveyor's document and drawing was completee over a year before it was enclosed in xref:image6-right-page.adoc[document 4], which is
dated October 18, 1800. 
