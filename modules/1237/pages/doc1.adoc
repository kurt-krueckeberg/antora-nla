...
The the xref:#forestry-assessment[Forestry Assessment] represents the
Cammer's official response, and this is noted by the vertical text along
the left edge just below the Land Assessment.
