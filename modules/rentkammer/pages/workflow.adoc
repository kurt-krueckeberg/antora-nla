...
`N.` or `Num: Cam:`:: The Kammer file number for the case.

`Num: Pr:` or `N: pr.`:: The entry number assigned when that specific document was entered in the Kammer’s register of received or sent documents.

`ad N: C. ... anni ...`:: A cross-reference to another Kammer file. It means that the present document is to be associated with, compared with, or filed in relation to that earlier or related case.
...
`ad N: C. 62. anni 1817`:: Under Kammer no. 62 of the year 1817.

`ad N: C. 168 & 101 anni 1818`:: Under Kammer nos. 168 and 101 of the year 1818.
