...
The Rentkammer case file xref:146:index.adoc[Die Stätte Nr. 18 zu
Berenbusch], which has this Bückeburg archive identification
link:https://www.arcinsys.niedersachsen.de/arcinsys/detailAction?detailid=v4979522[NLA
BU K 2 B Nr. 146], is about the Einlieger (lodger) Jobst Heinrich
