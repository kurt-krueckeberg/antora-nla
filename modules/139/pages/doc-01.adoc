...
The images below show the first two documents in the cluster of five documents designated as #1 in the
xref:contents-list.adoc[contents list].
...
continues on the right side of the back page. The images below have been cropped
to show only the text of the petition.
