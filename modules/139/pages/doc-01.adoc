...
The images below show the first two documents in the cluster of five documents designated +
as #1 in the xref:contents-list.adoc[contents list].
...
The two images below give an overview of the content of the first two brief documents in the case file:
