...
. *Rought draft (Concept) of the official reply (Rescript) to the widow Krückeberg* 
. *Likewise: sealed (with the official seal) and signed by Schmöe, Kahlhuth and Creuzinger of Baum*.
. *Rough draft (Concept) of the rescript originating from the Office of Bückeberg*
