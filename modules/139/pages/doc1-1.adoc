...
The petition of window Krückeberg begins on the *right sie of the first
page*, and it continues on the *right side of the back page*. She is needy
and facing financial difficulties. She is 58 years old and she can’t
perform the feudal duties of the *Burgrest labor days* and the *forestry
services* owed to the state of a *Colon* nor can she afford to hire someone
in her place. She petitions for these duties to be remitted.
...
the xref:content.adoc[Designatio Actorum] (the contents list). These are:
