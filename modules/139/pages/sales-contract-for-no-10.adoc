...
|===
|image::11-r.png[[title=page 1 (Click to Enlarge),link=self]
|image::12-l.png[[title=page 2 (Click to Enlarge),link=self]
|===


[cols="1a (Click to Enlarge),1a",options="noheader"]
|===
|image::12-r.png[[title=page 3 (Click to Enlarge),link=self]
|image::13-l.png[[title=page 4 (Click to Enlarge),link=self]
|===
...
<details class="narrow">
  <summary><strong>Show / hide Explanation of Sales Contract</strong></summary>
++++
...
++++
<details class="narrow">
  <summary><strong>Show / hide Glossary</strong></summary>
++++
