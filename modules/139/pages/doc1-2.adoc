...
is merely the left side of the xref:doc1-1.adoc#images-of-petition-of-the-widow-krückeberg[first page].
the widow Krückeberg's petition.

== Image of Report from Bückeburg Office

image::02-left-side-of-page.png[title=Click to Enlarge,width=75%,link=self]
