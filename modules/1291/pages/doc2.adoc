...
image::03-r.png[width=70%,link=self]
...
[literal.bordered,subs="verbatim,quotes"]
....
R. Cam. The Chamber is of the opinion that the small parcel marked with A
on the drawing, about 1/2 Morgen, should be granted to Krückeberg for a
reasonable payment. Instruction to the Office: it is to inform Krückeberg
of this, hear any objections of those entitled to grazing rights, and then
