...
[literal.bordered,subs="verbatim,quotes"]
....
Auf Befehl der Forst Direction soll der Platz, mit A und B. bezeichnete
für zwey Neubauer sein, welcher in der Petzer Hanß belegen, und an Nordholz
grenzet.
