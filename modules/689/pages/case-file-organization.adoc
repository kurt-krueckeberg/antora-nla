...
this number written in the upper right corner of the first page. It will be bordered (or
paritially bordered) by square. Take, for example, entry #2 in the contents list, which is
xref:doc-02.adoc#doc-index-2-1[Bericht Amts Bückeburg]. The upper right corner of the first
page of the xref:doc-02.adoc#doc-index-2-1[Bericht Amts Bückeburg] has *2* enclosed within
a square border:
