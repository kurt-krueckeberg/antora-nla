...
*number 2* in the able above is the xref:689:amt-decree.adoc[Bericht Amts Bückeburg] (the Report
...
+
image::689:15-r-vertical.png[title="Text begins with RC.",link=self]
