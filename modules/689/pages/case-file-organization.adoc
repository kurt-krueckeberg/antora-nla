...
=== Cross-Referencing the Contents List to Documents

For number in column one of the Acten Designation, the contents list, the first document listed will have
its corresponding Acten Designation entry number written in the upper right corner of the first page.
It will be bordered (or paritially bordered) by square. Take, for example, entry #2 in the contents list, 
which is xref:doc-02.adoc#doc-index-2-1[Bericht Amts Bückeburg]. The upper right corner of the first page
of the xref:doc-02.adoc#doc-index-2-1[Bericht Amts Bückeburg] has *2* enclosed within a square border:
...
_That’s why #10 has no boxed number in the case file._
====
...
These numbered increased through out the year. They mark the chronological order of handling. *Examples*:  
...
* *ad NC* = “in reference to NC \####”. It links a later follow-up document to an earlier one. 
