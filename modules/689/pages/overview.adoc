...
* the *treasury* of the principality (managing the prince’s revenues and expenditures),
* the *chief accounting office* (keeping the ledgers, reviewing and auditing the Amts’ accounts), and
* the *property management authority* (overseeing farmland, forests, mills, and other sources of income within the state).  
