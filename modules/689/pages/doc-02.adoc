...
The first image appears in the lower right corner of a left-hand page, whose opposite side is blank the, and the
page opposite it, the left-hand page is the image shown above. The 2nd image is likewise in the lower right corner
two pages from the 1st image.
...
1^st^ image i
The first image is essentially a billing note documenting what Krückeberg owed for:
