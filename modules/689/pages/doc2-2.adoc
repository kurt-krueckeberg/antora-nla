...
Amt is instructed to notify Krückeberg in line with its 7 October report.
...
already been formally served.  It is a billing note documenting what
Krückeberg owed for:

* having the Rentkammer’s decree written, registered, sealed, and
  dispatched,

* and for receiving the official copy (the Gegen-Bescheid).

These were small, fixed fees established in the Kanzleiordnung (Chancery
Fee Ordinance) — standard administrative costs, not fines or penalties.
