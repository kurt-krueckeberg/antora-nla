...
*TODO:* Re-read the summary and compare it to the text for clarity and accuracy. Make it 
more succinct.

[[doc-index-3-1]]
== Petition of Colon Krückeberg (11 Nov. 1841)
...
The note _RC. Seite 3_ (Rentcammer page 3) refers to the third page in the set of three documents
comprising #3 in the Acten Designation, the contents list, which is the 2^nd^ document, the 
xref:doc-03.adoc#doc-index-3-2[Vortrag des GKR od Reck (Memorandum by Government Councillor von Reck)].
...
On 15 November 1841, the Privy Chamber Councillor Reck prepared a formal valuation of Krückeberg’s farmstead and
buildings. After deducting debts, he calculated a net worth of 825 Reichsthaler, but judged it doubtful whether a
further 200 rt loan would be secure. Although acknowledging loans had been made in worse cases, he recommended
against approval, and the Gesuch (the petition for a loan by Johann Heinrich Krückeberg was marked to be refused.
...
[intials of those who worded text]
_Lm_ _L_
