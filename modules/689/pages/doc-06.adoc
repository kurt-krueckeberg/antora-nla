...
*TODO:* Explain the purpose of the text in the left margin and the "RC." note
at the end of the document. Get rid of the less than helpful table headings.

[[doc-index-6-1]]
== Report of Senior Government Councillor von Reck (16 Dec, 1841)

[cols="1a,1a",frame=none,grid=none]
|===
|image::15-r-original.png[title="Click to Enlarge",link=self]
|*Vertical text in prior image rotated right*

image::15-r-vertical.png[title="Click to Enlarge",link=self]
|===
...
Land zu demselben Preise zurückzukaufen für welchen es dem
Krü ckeberg verkauft ist. Dieß ist aber das Doppelte von dem von 
p Kreutzinger eingegebnen Werthe.
Bbg 16. Decbr 41
...
[caption="Large Vertical text in left margin: "] 
...
[cols="1a,1a",frame=none,grid=none]
|===
|image::16-l.png[title="Click to Enlarge",link=self]
|
|===
...
Vermögens-Umständen dieses Grundstück zu dem angegebenen hohen
...
|===
|image::16-l.png[title="Click to Enlarge",link=self]
|image::16-r.png[title="Click to Enlarge",link=self]
|===

[cols="1a,1a",frame=none,grid=none,options="noheader"]
|===
|image::17-l.png[title="Click to Enlarge",link=self]
|
|===
...
the Sovereign ruler of Schaumburg-Lippe, Georg Wilhelm, Prince of Schaumburg-Lippe.

[cols="1a,1a",frame=none,grid=none]
|===
|image::17-l-vertical-text.png[title="Click to Enlarge",link=self]
|
|===
