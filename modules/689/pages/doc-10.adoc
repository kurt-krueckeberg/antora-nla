...
[This text was not left aligned, but it is here]
Die Obligation vom 12.
Januar 1842 über die dem Col.
Krückeberg Nr. 10 in Berenbusch
aus Kammerkasse geliehenen
200 x[Rthlr.] Cour[ant]. wird mit Quittung
versehen dem p[er] Berger unter
Bezugnahme auf die Anweisung
vom 21. pr[aesentis]. (zur Übergabe an
...
Fr. der Wahlmeckwart[<- one word or two?]
