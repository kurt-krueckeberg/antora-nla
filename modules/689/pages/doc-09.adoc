= #9 Document: Report from the District Office of Bückeburg (8 Feb 1842)
:page-role: wide

*TODO:* The translation is missing the docketing present in the transliteration.

[cols="1a,1a",options="noheader",frame=none,grid=none]
|===
|image::20-r.png[title="Click to Enlarge",link=self]
|
|===
...
B.
By order of 5 May 1845, no. 2696, the enclosed promissory note
