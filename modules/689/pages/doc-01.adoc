[[doc-index-1-1]]
= 1: Petition of Colon Krückeberg No. 10 in Berenbusch
:page-role: wide

*TODO:* The document ends with "Nro g d." Waht does this mean? The same or nearly the same appears at the end
of document 3, also a petition. But each has a different transliteration and translation.
...
[cols="1a,4a",options="noheader",width="60%"]
|===
s|NC. 4381
<|Registry/file number (NC-series). 

s|pr. in Cam. 2 Oct. 1841
