...
....
[upper left]  NC. 5203  
[upper right] pr. in Cam 24 Nov.    4
...
....
[upper left]  NC. 5203
[upper right] presented in the Chamber on 24 November 1841        
...
Analyze the bottom text that continues onto the next page. From the three initials, there seem to have been 3
individuals on the Rentcammer including Reck. The initials of the other can be better discerned from other
documents.
