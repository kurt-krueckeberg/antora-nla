...
The note _RC. Seite 3_ (Rentcammer page 3) refers to the third page in the
set of three documents comprising docket item #3 in the Acten Designation,
the contents list, which is the 2^nd^ document, the
xref:doc3.adoc#doc-index-3-2[Vortrag des GKR od Reck (Memorandum by
Government Councillor von Reck)].
