= Docket Item 6: Filing note by Councillor Reck and the supreme official order of His Serene Highness (23 Dec.
1841)
:page-role: wide
...
On the last page, written vertically in the left margin--rotated below so
