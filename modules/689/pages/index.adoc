...
he arrived from a principality only three and a half times the size of Union Township with 20,000
...
By 1841 the regency no longer existed. This was when Johann Heinrich's sore financial trials entered the public
record of Schaumburg-Lippe. This time it would be the Rentcammer who would render a decision. 
