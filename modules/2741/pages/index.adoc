...
in the
link:https://www.arcinsys.niedersachsen.de/arcinsys/start.action[Arcinsys Archival information system Niedersachsen and Bremen].
...
The householders are each asked 40 questions. The questions are not given.
...
image::2741-1.jpg[width="75%",title=First page (Click to Enlarge),link=self]

image::2741-2.jpg[width="75%",title=Second page (Click to Enlarge),link=self]

image::2741-3.jpg[width="75%",title=Third page (Click to Enlarge),link=self]
...
None of these individuals appears in the 1737 xref:2728:survey-1737.adoc[],
...
[IMPORTANT]
====
The reply to question #1 only gives the prior holders of no. 10 Berenbusch.
