...
in the link:https://www.arcinsys.niedersachsen.de/arcinsys/start.action[Arcinsys]
...
image::2713-24.png[title=Johann Heinrich Krückeberg's holding,link=self]
...
Summa Summarum                          ¾ [Morgen]   29 [Ruten]
....
...
The homestead plot, on which a dwelling house stands,
measures 6 Ruten.

The garden beside the house measures
¾ Morgen 23 Ruten.
