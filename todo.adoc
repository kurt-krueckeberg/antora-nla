...
2. Double check that image3-official-reaction is accurate. Turn the overview into a narrative.
3. See the "TODO" section I added (From chatgpt). It is not yet part of timeline.adoc.
