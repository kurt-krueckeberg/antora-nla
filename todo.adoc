...
* In all the documents (since around document 5), chanage all occurances of "Obligation" to
"loan bond" as in doc-08.adoc
...
+
But first work on understanding and reorganizing nc-5702.adoc
...
* The Amt officials signatures are either "Hauck Neuhsel Höcker" or "Haadra MNenhsel Jöcker". The last signature
appears to begin with "Y" but "Yöcker" seems unlikely, I belive that "H" is possible for the first letter. 
