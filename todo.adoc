...
Determine the correct chronological order of the ancillary "documents", and what they mean.
The "Copt" single-page document is a cover slip for a particuliar main document.
