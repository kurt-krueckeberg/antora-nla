...
* Create xrefs from document index to the actual documents and supplemental documents mentioned. 
* Check the "NC" numbers for each document in the document index.
