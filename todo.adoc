...
Convert the literal document index into an AsciiDoc table. The literal version aligns those
entries that have dates. Lines of text without dates belong to the line above them that has
a date. Then submit the final AsciiDoc table along with the image to Chatgpt. 
