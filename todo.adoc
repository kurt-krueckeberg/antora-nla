...
* Add xref-links to all the document index entries.

* In document 6, I am not sure what part of it is the "Opinion of Councillor Reck and Decree of His Serene
Highness". The is long response after the "Sovereign Decree", which is anchor `[[doc-index-6-2]]`.
