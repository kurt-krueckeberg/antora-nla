...
* Break Document 1 into a landing, overview page and two subpages, one for the petition the other for the
report and a third for the endorsement
* For Document 2, I'm undecided if the same organization is needed?
