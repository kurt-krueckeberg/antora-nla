...
1. For doc-1-full.adoc the header is all left-aligned because a [verse] block was used. Switch the header portion
(of the forestry report) to a literal block and use verse block for the forestry report.
