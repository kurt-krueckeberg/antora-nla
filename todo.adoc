...
Create narrative overviews that fit in the overall story for each major document.

And determine the correct chronological order of the ancillary "documents", and explain their
purpose; for example, the "Copt" single-page document is a cover slip for a particuliar main document.

== 689

Finish overview.adoc and include inti footnotes that are defined at the end of the page and include
